...
//Date:3/29/2018
//File Description: This file is for most of the functions used
...
void SonarCheck(void)           //This function takes data from the sonar and calculates the distance and send the string to the LCD 
{
   ...
   {
      travelTime = ((echo + (65535 - init))/2);      //if it is greater, then it send the total travel time to a variable called travel time. 
   }
   else 
   {
   ...
   d = (1116*travelTime)/prescale;                   //this converts the distance from the value stored on the computer into feet and inches. 
